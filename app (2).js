...
renderFcDetail = function(root){
  ...
  // La photo de cette zone vient des "Médias de l'inventaire" (slot step:<zone>)
  const slot = `step:${fcState.zone}`;
  ...
  card.innerHTML = `
    ...
    <p class="muted" style="font-size:12px;margin-top:6px;">Cette photo est partagée avec « Médias de l’inventaire » (${fcEsc(fcState.zone)}) et utilisée pour l’impression.</p>
  `;
